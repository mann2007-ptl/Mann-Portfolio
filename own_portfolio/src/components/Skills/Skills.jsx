...
const Skills = () => {
    ...
    const skills = [
        ...
        { name: 'React Native', icon: <FaReact />, color: '#00B4D8' },
        ...
        { name: 'DBMS', icon: <FaDatabase />, color: '#A0A0A0' },
